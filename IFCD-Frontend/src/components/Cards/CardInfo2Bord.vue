	...
	<a-card :bordered="false" class="card-info-2 h-full">
		<div class="col-content h-full" style="background-image: url('images/info-card-2.jpg')">
			<div class="card-content">
				...
				<p>Wealth creation in agriculture is a long-term sustainable process. It's about seizing opportunities as they arise to maximize yields and ensure efficient production.</p>
			</div>
