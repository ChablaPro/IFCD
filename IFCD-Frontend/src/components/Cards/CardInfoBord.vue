		...
		<a-row type="flex">
			<a-col class="col-content" :span="24" :xl="12">
				<div class="card-content">
					<h6>Designed by agricultural experts</h6>
					<h5>IFDC for Agricultural Management</h5>
					<p>From colors to charts, typography, and complex elements, you'll find the complete documentation for effective management of your farm.</p>
				</div>
