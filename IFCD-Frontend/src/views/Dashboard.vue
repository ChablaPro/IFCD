...
<template>
	<div>
		<!-- Counter Widgets -->
		<a-row :gutter="24">
			<a-col :span="24" :lg="12" :xl="6" class="mb-24" v-for="(stat, index) in stats" :key="index" v-if="stats.length > 0">
				<!-- Widget 1 Card -->
			...
			<div style="display: flex; justify-content: center;" v-if="stats.length <= 0">
		...
		<a-row :gutter="24" type="flex" align="stretch">
			...
			<a-col :span="24" :lg="16" class="mb-24">
				...
				<!-- Projects Table Card -->
				<CardProjectTable :data="tableDataEvent" :columns="tableColumns"></CardProjectTable>
				<!-- / Projects Table Card -->
